    ...
    <div className="h-full bg-gray-100 relative">
      ...
      <MobileView>
        <div className='fixed flex flex-col items-end space-y-3 bottom-5 right-2'>
          ...
          <div onClick={() => setOpen(!open)} className='w-14 h-14 p-3 flex items-center rounded-full bg-white justify-center cursor-pointer' style={{ boxShadow: "rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px" }}>
