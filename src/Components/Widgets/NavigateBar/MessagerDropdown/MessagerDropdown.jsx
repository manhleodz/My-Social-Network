...
export default function MessagerDropdown() {
    ...
    return (
        <>
            <BrowserView>
                <div onClick={() => setOpenDropdown(!openDropdown)} className={` w-10 h-10 flex justify-center items-center relative bg-gray-300 rounded-full hover:bg-gray-400 active:ring-gray-300 active:ring cursor-pointer`}>
