    ...
    <>
      ...
      {option &&
        (<div onClick={(e) => {
          ...
          id={`bg-${comment.id}`}>
          <div className=' p-2 bg-white divide-y divide-gray-300 w-1/5 flex flex-col items-center justify-center rounded-xl'>
            <div className=' w-full cursor-pointer flex justify-center text-lg text-red-600 font-semibold py-1.5'
              onClick={reportCmt}
            >Báo cáo</div>
            {user.id === comment.UserId && (<div className=' w-full cursor-pointer flex justify-center text-lg text-red-600 font-semibold py-1.5'
              onClick={deleteCmt}
            >Xóa</div>)}
